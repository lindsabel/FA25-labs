...
1. Go to the Lab 0 assignment in Canvas and click "Start Assignment".
1. Upload the rendered .html file (called "lab00_report.html") to Canvas, and click "Submit Assignment".